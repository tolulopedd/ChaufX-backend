...
export default function ContactPage() {
  return (
    <PublicPageShell
      heroTitle="Contact"
      heroCopy="Reach the DriveMe team for onboarding, service, approval, or general platform questions."
    >
      <section className="bg-white">
        <div className="mx-auto max-w-5xl px-5 py-12 md:px-8">
          <div className="grid gap-4 lg:grid-cols-[0.42fr_0.58fr]">
            <div className="rounded-[30px] border border-[#E5E7EB] bg-[#F8FAFC] p-7 shadow-[0_24px_70px_-50px_rgba(15,23,42,0.18)]">
              ...
              <div className="mt-6 space-y-5">
                ...
                <div>
                  ...
                  <a href="mailto:info@drivemecanada.ca" className="mt-2 block text-lg font-semibold text-[#0F172A]">
                    info@drivemecanada.ca
                  </a>
                </div>
              </div>
            </div>
            ...
            <h2 className="text-3xl font-semibold tracking-[-0.05em] text-[#0F172A]">Talk to DriveMe.</h2>
            <p className="mt-4 max-w-2xl text-sm leading-7 text-slate-600">
              For service, onboarding, approval, or chauffeur opportunities in your province, send a message to the DriveMe admin team.
            </p>
